//===- unittest/Blue/BlueASTMatchersTest.h - Matcher tests helpers ------===//
//
...
#ifndef LLVM_CLANG_UNITTESTS_BLUE_ASTMATCHERSTEST_H
#define LLVM_CLANG_UNITTESTS_BLUE_ASTMATCHERSTEST_H
...
testing::AssertionResult matchesConditionally(
  ...
  public:
    ...
    std::unique_ptr<FrontendAction> create() override {
      return std::make_unique<blue::BlueSyntaxAction>(Finder);
    }
  };
  ...
  if (!Found && ExpectMatch) {
    ...
    public:
      ...
      std::unique_ptr<FrontendAction> create() override {
        return std::make_unique<blue::BlueSyntaxActionDumper>();
      }
    };
...
matchesConditionally(const std::string &Code, const T &AMatcher,
  ...
  auto Result =
      matchesConditionally(Code, AMatcher, ExpectMatch, "blue");
  if (!Result)
    return Result;
  // }
