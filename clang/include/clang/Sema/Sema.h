...
public:
  ...
  void ActOnTagFinishDefinition(Scope *S, Decl *&TagD, SourceRange BraceRange);
...
public:
  ...
  ExprValueKind getValueKindForDeclReference(QualType &type, ValueDecl *VD,
                                             SourceLocation Loc);
...
public:
  ...
  void suggestLifetimeAttribute(CXXRecordDecl *Record);
