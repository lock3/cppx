...
ExprDependence computeDependence(CppxCXXScopeSpecExpr *E);
ExprDependence computeDependence(CppxDependentMemberAccessExpr *E);
ExprDependence computeDependence(CppxCallOrConstructorExpr *E);
ExprDependence computeDependence(CppxDerefOrPtrExpr *E);
ExprDependence computeDependence(CppxWildcardExpr *E);
