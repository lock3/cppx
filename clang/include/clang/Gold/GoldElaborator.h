...
public:
  ...
  // True when this elaboration should "have no side effects". Used by
  // the GoldDeclaratorBuilder to differentiate parameter syntaxes.
  bool TemporaryElaboration = false;
  std::unordered_map<const Declaration *, Scope *> TemporaryElaboratedDecls;
