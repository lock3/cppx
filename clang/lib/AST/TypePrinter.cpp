...
void TypePrinter::printCppxKindBefore(const CppxKindType *T, raw_ostream &OS) {
  OS << "type";
}

void TypePrinter::printCppxKindAfter(const CppxKindType *T, raw_ostream &OS) {}

void TypePrinter::printCppxArgsBefore(const CppxArgsType *T, raw_ostream &OS) {
  OS << "args";
}
...
void TypePrinter::printCppxTemplateBefore(const CppxTemplateType *T, raw_ostream &OS) {
  OS << "TEMPLATE TYPE BEING PRINTED!";
}

void TypePrinter::printCppxTemplateAfter(const CppxTemplateType *T, raw_ostream &OS) {}
