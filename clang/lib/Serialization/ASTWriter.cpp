...
void TypeLocWriter::VisitCppxKindTypeLoc(CppxKindTypeLoc TL) {
  Record.AddSourceLocation(TL.getNameLoc());
}
...
void TypeLocWriter::VisitCppxArgsTypeLoc(CppxArgsTypeLoc TL) {
  Record.AddSourceLocation(TL.getNameLoc());
}

void TypeLocWriter::VisitCppxTypeExprTypeLoc(CppxTypeExprTypeLoc TL) {
  Record.AddSourceLocation(TL.getNameLoc());
}
