...
void TypeLocReader::VisitCppxKindTypeLoc(CppxKindTypeLoc TL) {
  TL.setNameLoc(readSourceLocation());
}

void TypeLocReader::VisitCppxNamespaceTypeLoc(CppxNamespaceTypeLoc TL) {
  TL.setNameLoc(readSourceLocation());
}
...
void TypeLocReader::VisitCppxTypeExprTypeLoc(CppxTypeExprTypeLoc TL) {
  TL.setNameLoc(readSourceLocation());
}
